...
@section('title', 'Curso - Regularización de Inglés')
        ...
        <div class="container">             
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="{{ url('/') }}">Inicio </a>  <span class="lnr lnr-arrow-right"></span>  <a href="#">Regularización de Inglés</a></p>
                </div>  
            </div>
        </div>
    </section>
