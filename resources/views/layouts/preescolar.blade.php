...
@section('content')
    ...
    <section class="sample-text-area">
        <div class="container">
            ...
            <p class="sample-text">
                Somos un colegio de alto rendimiento con primeros lugares en la competencia <b>Cotorra de matemáticas</b> y las <b>Olimpiadas del conocimiento</b> a nivel <u>zona</u>, <u>región</u> y <u>estado</u>. Comprometidos con fomentar una educación que desde temprana edad haga trascender a nuestros alumnados, para ello hemos destacados en diferentes justas de conocimiento siendo reconocidos por nuestros valores e ideales. Nuestro semillero - preescolar - es una de nuestras más grandes satisfacciones ¿Quieres saber más? Te invitamos a conocerlo ¡Que esperas!
            </p>
        </div>
    </section>
    <!-- End Sample Area -->
    ...
    <div class="whole-wrap">
        <div class="container">
            <div class="section-top-border">
                <h3 class="mb-30">Instalaciones Preescolar</h3>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9 mt-sm-20 left-align-p">
                        <p>
                            Sabemos lo importante que es contar con un entorno de desarrollo agradable, por esa razón contamos con instalaciones de <b>primer nivel</b> que permiten a nuestros pequños estudiantes adquirir habilidades a temprana edad a través de la convivencia, socialización, juegos y diversión. <br><br>
            ...
            <div class="section-top-border">
                <div class="row">
                    ...
                    <div class="col-md-4 mt-sm-30 typo-sec">
                        <h3 class="mb-20"> Preescolar</h3>
                        <div class="">
                            <ul class="unordered-list">
                                <li>Entrada 08:00 AM</li>
