...
@section('title', 'Inscripciones 2019')
    ...
    <div class="whole-wrap">
        <div class="container">
            <div class="section-top-border">
                <h3 class="mb-30">Ciclo de Inscripciones</h3>
                <div class="row">
                    <div class="col-md-3">
                        <img src="img/registration/demo.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-9 mt-sm-20 left-align-p">
                        <p>Somos un Colegio de alto rendimiento con calidad en servicio a costos accesibles. Te esperamos en un horario de 08:00 A.M. a 03:00 P.M Agenda una cita especial comunicándote a los teléfonos del Colegio.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="section-top-border">
                <div class="row">
                    ...
                    <div class="col-md-4 mt-sm-30 typo-sec">
                        <h3 class="mb-20">¿Que incluye?</h3>
                        <div class="">
                            <ul class="unordered-list">
                                <li>Libros de inglés</li>
                                <li>Libro de matemáticas</li>
                                ...
                                <li>Pago del 50% Certificación Cambridge</li>
                                <li>Plataforma CLMS</li>
                                <li>Talleres sabatinos gratuitos</li>
                                <li>Materiales</li>
                            </ul>
                        </div>
                    </div>
